...
export const E_FETCH_CREATE_VAULT_SUCCESS = '[vaults] [Event] Create vault success';
export const E_FETCH_DELETE_VAULT_SUCCESS = '[vaults] [Event] Delete vault success';
...
export const E_FETCH_CREATE_VAULT_ERROR = '[vaults] [Event] Create vault error';
export const E_FETCH_DELETE_VAULT_ERROR = '[vaults] [Event] Delete vault error';
