...
export default class EtheriumIcon extends React.Component {
  render() {
    return (
      <View
        style={[
      ...
      >
        <Svg width="11" height="18" viewBox="0 0 11 18" fill="none">
          <Path d="M5.326 0.565674L5.21094 0.955074V12.2546L5.326 12.3689L10.5939 9.26857L5.326 0.565674Z" fill="#343434"/>
          <Path d="M5.32671 0.565674L0.0588379 9.26855L5.32671 12.3689V6.88452V0.565674Z" fill="#8C8C8C"/>
          <Path d="M5.32595 13.362L5.26111 13.4407V17.4659L5.32595 17.6544L10.597 10.2632L5.32595 13.362Z" fill="#3C3C3B"/>
