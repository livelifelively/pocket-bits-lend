      ...
      <View style={{marginBottom: 25, width: '100%'}}>
        ...
        <WhiteView style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10, padding: 20}}>
          <View style={{flexDirection: 'row', justifyContent: 'space-between', width: '100%', alignItems: 'center'}}>
            <View><Text style={{fontSize: 10}}>S*************@gmail.com</Text></View>
            <View><Text style={{fontSize: 14, fontFamily: 'Poppins-Bold'}}>$0.004</Text></View>
            <View><Text style={{fontSize: 10}}>19 Mar, 21</Text></View>
          </View>
        </WhiteView>
        <WhiteView style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10, padding: 20}}>
          <View style={{flexDirection: 'row', justifyContent: 'space-between', width: '100%', alignItems: 'center'}}>
            <View><Text style={{fontSize: 10}}>D*************@gmail.com</Text></View>
            <View><Text style={{fontSize: 14, fontFamily: 'Poppins-Bold'}}>$0.013</Text></View>
            <View><Text style={{fontSize: 10}}>19 Mar, 21</Text></View>
          </View>
        </WhiteView>
      </View>
